		...
		<main className="policy">
			...
			<ol className="policy-container">
				<li className="poliy-item">
					...
					<p className="policy-text">
						...
						Онлайн-сервисом "Спортивный гид" (далее — Оператор).
					</p>
				</li>
				<li className="poliy-item">
					<p className="policy-text">
			...
			<ul className="policy-container">
				...
				<li className="poliy-item">
					...
					<p className="policy-text">
						...
						обработку персональных данных, а также при получении обращения о
						прекращении обработки персональных данных, оператор вправе
						продолжить обработку персональных данных без согласия субъекта, если
						имеются основания, указанные в Законе о персональных данных.{' '}
					</p>
					<p className="policy-text">
			...
			<ul className="policy-container">
				...
				<p className="policy-text">
					...
					доступной форме и не содержат персональные данные, относящиеся к
				...
				<p className="policy-text">
					- Отзывать согласие на обработку персональных данных, а также
			...
			<ol className="policy-container">
				...
				<p className="policy-text">
					...
					электронных писем Персональные данные электронный адрес номера
					телефонов имя Правовые основания Федеральный закон «Об информации,
					информационных технологиях и о защите информации» от 27.07.2006 N
					149-ФЗ Виды обработки персональных данных Сбор, запись,
			...
			<ol className="policy-container">
				...
				<p className="policy-text">
					...
					Sports-map@yandex.ru с пометкой «Актуализация персональных данных».
				</p>
				<p className="policy-text">
					...
					на электронный адрес Оператора Sports-map@yandex.ru с пометкой «Отзыв
			...
			<ol className="policy-container">
				...
				<p className="policy-text">
					...
					до замены ее новой версией.транного государства, иностранных
