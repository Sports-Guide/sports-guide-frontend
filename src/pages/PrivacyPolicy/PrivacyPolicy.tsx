...
const PrivacyPolicy: FC = () => (
	<main className="policy">
		...
		<ol className="policy-container">
			<li className="poliy-item">
				<h3 className="policy-title">1. Общие положения</h3>
				<p className="policy-text">
					...
					безопасности персональных данных, предпринимаемые Онлайн-сервисом
					"Спортивный гид" (далее — Оператор).
				</p>
			</li>
			<li className="poliy-item">
				<p className="policy-text">
				...
				<p className="policy-text">
					...
					<a
						href="https://sports-map.ru/"
						className="policy__main-page-link"
						target="_blank"
						rel="noreferrer"
					>
						https://sports-map.ru/
		...
		<ul className="policy-container">
			...
			<li className="poliy-item">
				...
				<p className="policy-text">
					...
					персональных данных, а также при получении обращения о прекращении
					обработки персональных данных, оператор вправе продолжить обработку
					персональных данных без согласия субъекта, если имеются основания,
		...
		<ul className="policy-container">
			...
			<p className="policy-text">
				...
				форме и не содержат персональные данные, относящиеся к другим субъектам
			...
			<p className="policy-text">
				- Отзывать согласие на обработку персональных данных, а также направлять
			...
			<p className="policy-text">
				4.3. Лица, передавшие Оператору недостоверные сведения о себе или
		...
		<ol className="policy-container">
			<li className="poliy-item">
				<h3 className="policy-title">
					5. Принципы обработки персональных данныхе положения
				</h3>
			</li>
			<p className="policy-text">
		...
		<ol className="policy-container">
			<li className="poliy-item">
				<h3 className="policy-title">6. Цели обработки персональных данных</h3>
			</li>
			<p className="policy-text">
				...
				имя Правовые основания Федеральный закон «Об информации, информационных
				...
				уничтожение и обезличивание персональных данных Отправка информационных
		...
		<ol className="policy-container">
			...
			<p className="policy-text">
				...
				уведомление на адрес электронной почты Оператора Sports-map@yandex.ru с
			...
			<p className="policy-text">
				...
				электронный адрес Оператора Sports-map@yandex.ru с пометкой «Отзыв
		...
		<ol className="policy-container">
			<li className="poliy-item">
				<h3 className="policy-title">12. Заключительные положения</h3>
			</li>
			<p className="policy-text">
				...
				Оператору с помощью электронной почты sports-map@yandex.ru.
			</p>
			<p className="policy-text">
				...
				до замены ее новой версией.транного государства, иностранных физических
